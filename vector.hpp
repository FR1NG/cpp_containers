...
//                this->_capacity = n;
        ...
        void insert (iterator position, size_type n, const value_type& val)
        {
            ...
            {
                value_type tmp = this->_allocator.allocate(this->size() + n);
                for (iterator it = this->begin(); it != position  ; ++i) {
...
//    ! prototypes only
    ...
    private:
        ...
        void _reconstruct(iterator begin, iterator end, pointer target)
        {
            for (iterator it = begin; it != end; it++)
                this->_allocator.construct(target, val);
        }
